...
public class PlayerStatus implements Graphic.IRenderableObject {
	...
	private boolean lasthitismiss = true;
	...
	public void update() { // update after each BPM
		...
		if(combocount%15 ==0 && combocount >0  && hp <100)
			hp+=20;
	...
	public boolean isLasthitismiss() {
		return lasthitismiss;
	}

	public void setLasthitismiss(boolean lasthitismiss) {
		this.lasthitismiss = lasthitismiss;
	}
