...
public class DrawingUtility {
	...
	private static BufferedImage getImage(String directory) {
		try {
			...
			System.out.println("can't load " + directory);
			return null;
		}
	}
	...
	protected static final BufferedImage ht100 = getImage("res/img/bg/howto/100.jpg");
	protected static final BufferedImage ht80 = getImage("res/img/bg/howto/80.jpg");
	protected static final BufferedImage ht60 = getImage("res/img/bg/howto/60.jpg");
	protected static final BufferedImage ht40 = getImage("res/img/bg/howto/40.jpg");
	protected static final BufferedImage ht20 = getImage("res/img/bg/howto/20.jpg");
	protected static final BufferedImage ht0 = getImage("res/img/bg/howto/0.jpg");
	...
	public static BufferedImage getHowto(int i) {
		if(i == 0) return ht100;
		if(i == 1) return ht80;
		if(i == 2) return ht60;
		if(i == 3) return ht40;
